...
```{r, fig.cap = "Unieke functionele groepen apoidea voor transecten (TS) vs. pan traps (PT)."}
venn(nat_ap, "method_cd", "optional_functional_group")
```

```{r, fig.cap = "Unieke functionele groepen apoidea per submethode."}
venn(nat_ap, "method_combi", "optional_functional_group")
```

```{r, fig.cap = "Unieke functionele groepen apoidea per maand."}
