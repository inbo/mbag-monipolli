...
Following the proposed protocol 1000 m transects will be walked three times as well, once each for bees, hoverflies and butterflies.
...
for (t in trends) {
  for (l in locations) {
    ...
    result <- run_power_analysis(t, l, nsim = 250)
