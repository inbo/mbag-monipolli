...
```{r}
# Geen honingbijen in analyse, wil je dit wel dan moet je de volgende regels uitcommentariëren
identifications <- identifications |>
...
```{r}
model5 <- glmmTMB(prop ~ cumulative_days * method_combi + (1|sampling_site_method),
                  family = binomial,
