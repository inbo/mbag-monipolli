...
```{r, fig.cap = "Verwacht aantal soorten in een pantrap-set of transectsegment van 50 m per maand en soortgroep op basis van ons model."}
marginaleffects::plot_predictions(
  model1,
...
```{r, fig.cap = "Verwacht aantal individuen in een pantrap-set of transectsegment van 50 m per maand en soortgroep op basis van ons model."}
marginaleffects::plot_predictions(
  model2,
  condition = c("maand", "taxgroup"),
  type = "response",
