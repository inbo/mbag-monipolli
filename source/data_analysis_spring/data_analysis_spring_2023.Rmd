...
pred_spec |>
  ...
  scale_x_discrete(guide = guide_axis(n.dodge = 2),
                   labels = c("Pan trap: Non-UV, soil surface",
...
emmeans::emmeans(model4, ~log(number_of_floral_units + 1) * group, infer = TRUE)
...
```{r}
model5 <- glmmTMB(prop ~ log(cumulative_days) * method_combi +
...
```{r}
emm <- emmeans::emmeans(model5, pairwise ~ cumulative_days,
                 type = "response",
                 at = list(cumulative_days = c(0.25,
                                               1.25,
                                               2.25,
                                               3.25,
                                               4.25,
...
Verwacht percentage van de "totale" gemeenschap dat gevonden wordt voor het aantal dagen dat pan traps geplaatst worden:
```{r}
emmeans::emmeans(model6, trt.vs.ctrl1 ~ cumulative_days,
                 type = "response",
                 at = list(cumulative_days = c(0.25,
                                               1.25,
                                               2.25,
...
slopes <- emmeans::emtrends(model9, 
                  specs = "method_combi", 
...
Verwacht percentage van de "totale" gemeenschap dat gevonden wordt voor het aantal dagen dat pan traps geplaatst worden:
```{r}
emmeans::emmeans(model7, trt.vs.ctrl1 ~ cumulative_days,
                 type = "response",
                 at = list(cumulative_days = c(0.25,
                                               1.25,
                                               2.25,
